...
public abstract class JmDNS implements Closeable
{
     ...
     * Note that the given {@code ServiceInfo} is bound to this {@code JmDNS} instance, and should not be reused for any other {@linkplain #registerService(javax.jmdns.ServiceInfo)}.
     *
     * @param info
