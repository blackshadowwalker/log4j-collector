 ...
 * This class will monitor network topology changes, and will create or destroy JmDNS instances as required. It is your responsibility to maintain services registration (hint: use a {@link javax.jmdns.NetworkTopologyListener}).<br/>
    ...
    public static interface NetworkTopologyDiscovery
    {
        public static class Factory
        {
            ...
            public static interface ClassDelegate
            {
                 ...
                 * @see #classDelegate()
                 * @see #setClassDelegate(javax.jmdns.JmmDNS.NetworkTopologyDiscovery.Factory.ClassDelegate anObject)
                 */
                public NetworkTopologyDiscovery newNetworkTopologyDiscovery();
            }
